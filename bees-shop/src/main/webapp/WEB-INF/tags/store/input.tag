...
<%@ attribute name="group" required="false" type="java.lang.String" description="Validate multiple inputs as a single entity." %>
...
<c:set var="attributes">
	...
	<c:if test="${!empty group}"> data-fieldgroup="${group}"</c:if>
</c:set>
